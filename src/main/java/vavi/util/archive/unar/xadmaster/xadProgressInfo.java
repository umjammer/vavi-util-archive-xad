...
public class xadProgressInfo extends Structure {
	 ...
	 * C type : xadClient*
	 */
	public vavi.util.archive.unar.xadmaster.xadClient.ByReference xpi_Client;
	/**
	 * current diskinfo, for disks<br>
	 * C type : xadDiskInfo*
	 */
	public vavi.util.archive.unar.xadmaster.xadDiskInfo.ByReference xpi_DiskInfo;
	/**
	 * current info for files<br>
	 * C type : xadFileInfo*
	 */
	public vavi.util.archive.unar.xadmaster.xadFileInfo.ByReference xpi_FileInfo;
	/**
	 * current filesize<br>
	 * C type : xadSize
	 */

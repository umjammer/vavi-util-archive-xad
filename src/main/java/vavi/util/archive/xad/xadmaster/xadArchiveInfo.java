...
public class xadArchiveInfo extends Structure {
	 ...
	 * C type : xadClient*
	 */
	public vavi.util.archive.xad.xadmaster.xadClient.ByReference xai_Client;
	/**
	 ...
	 * C type : xadFileInfo*
	 */
	public vavi.util.archive.xad.xadmaster.xadFileInfo.ByReference xai_FileInfo;
	/**
	 * data pointer for disk arcs<br>
	 * C type : xadDiskInfo*
	 */
	public vavi.util.archive.xad.xadmaster.xadDiskInfo.ByReference xai_DiskInfo;
	/**
	 * data pointer for current file arc<br>
	 * C type : xadFileInfo*
	 */
	public vavi.util.archive.xad.xadmaster.xadFileInfo.ByReference xai_CurFile;
	/**
	 * data pointer for current disk arc<br>
	 * C type : xadDiskInfo*
	 */
	public vavi.util.archive.xad.xadmaster.xadDiskInfo.ByReference xai_CurDisk;
	/**
	 ...
	 * C type : xadSkipInfo*
	 */
	public vavi.util.archive.xad.xadmaster.xadSkipInfo.ByReference xai_SkipInfo;
	/**
	 * for filesystem clients (V5)<br>
	 * C type : xadImageInfo*
	 */
	public vavi.util.archive.xad.xadmaster.xadImageInfo.ByReference xai_ImageInfo;
	/**
